  ...
  return (
    <div className="border border-moderate bg-surface p-4">
      <div className="flex items-center gap-2.5">
        <span
          aria-hidden
          className="inline-flex size-5.5 shrink-0 items-center justify-center bg-moderate font-cond text-[15px] font-semibold text-surface"
        >
          !
        </span>
      ...
      <ul className="mt-3 space-y-2">
        {warnings.map((w) => (
          <li key={w.code} className="flex items-start gap-2.5 text-[13px] leading-normal">
            <span aria-hidden className="mt-1.75 size-1.5 shrink-0 bg-moderate" />
